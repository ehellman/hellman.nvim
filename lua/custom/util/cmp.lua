...
function M.setup(opts)
  ...
  local original_parse = require("cmp.utils.snippet").parse
  require("cmp.utils.snippet").parse = function(input)
    local ok, ret = pcall(original_parse, input)
    if ok then
      return ret
    end
    return HellVim.cmp.snippet_preview(input)
  end
  ...
  --   HellVim.cmp.auto_brackets(event.entry)
  -- end
  -- end)
  -- cmp.event:on("menu_opened", function(event)
  --   HellVim.cmp.add_missing_snippet_docs(event.window)
  -- end)
end
